const addNewTransaction = (req, res, next) => {
    const {id_user, id_product, qty, id_total, id_delivery, time, date, id_payment_methods, address} = req.body
    ...
    if(validateQuery.length < 9){
        return res.status(400).json({
            error: "d_user, id_product, qty, id_total, id_delivery, time, date, id_payment_methods, and address!",
